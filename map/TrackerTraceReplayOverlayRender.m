//
//  TrackerTraceReplayOverlayRender.m
//  Tracker
//
...
#import "TrackerTraceReplayOverlayRender.h"

@interface TrackerTraceReplayOverlayRender ()
{
...
@implementation TrackerTraceReplayOverlayRender
- (instancetype)initWithOverlay:(id<MAOverlay>)overlay
{
    ...
    if(self){
        ...
        TrackerTraceReplayOverlay *traceOverlay = (TrackerTraceReplayOverlay *)overlay;
...
- (void)glRender
{
    ...
    TrackerTraceReplayOverlay *traceOverlay = (TrackerTraceReplayOverlay *)self.overlay;
